...
//    public static final int STYLE_MATERIAL = 0;
    ...
    private PullHeaderView mRefreshView;
...
//    private RefreshDrawable mRefreshDrawable;
    ...
    public PullRefreshLayout(Context context, AttributeSet attrs) {
        ...
        mRefreshView = new PullHeaderView(context);
        mRefreshView.setPullLayout(this);
        mColorSchemeColors = context.getResources().getIntArray(colorsId);
        mRefreshView.setColorSchemeColors(mColorSchemeColors);
...
//                    float adjustedPercent = dragPercent;
                ...
                if (scrollTop < mTotalDragDistance) {
                    mRefreshView.setPercent(dragPercent);
                }
