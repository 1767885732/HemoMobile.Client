...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     * http 访问头部设置
     * @author lijianyu
     * @since 2014-8-25 16:17:58
     */
    Map<String, String> httpHeaders = null;
    
    /**
     * 缓存是否可以控制，默认为false(即服务端headers控制)，true即客户端控制有效期等，控制方式，为放在请求头设置里，与服务端设置一样
     * @author lijianyu
...
//        return Collections.emptyMap(); by lijianyu
    	
    	// add by lijianyu in 2014-8-25 16:19:19
    	if(httpHeaders == null)
	...
	/**
	 * Checks if is cache control enable.
	 *
	...
	/**
	 * Sets the cache control enable.
	 *
	 * @param isCacheControlEnable the new cache control enable
	 */
