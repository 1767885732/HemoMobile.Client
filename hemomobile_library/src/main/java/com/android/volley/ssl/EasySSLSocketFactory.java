...
import com.mdsd.library.MdsdLibApplication;
...
public class EasySSLSocketFactory implements LayeredSocketFactory {
    ...
    private static SSLContext createEasySSLContext() throws IOException {
        try {
        	...
        	InputStream clientStream = MdsdLibApplication.getContext().getResources().openRawResource(R.raw.production_test_client);
	        ...
	        instream = MdsdLibApplication.getContext().getResources().openRawResource(R.raw.production_test_ca);
